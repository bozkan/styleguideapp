...
class LogosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create logo" do
    assert_difference('Logo.count') do
      post logos_url, params: { logo: { brand_id: @logo.brand_id, description: @logo.description, file_data: @logo.file_data, name: @logo.name } }
    end
  ...
  test "should update logo" do
    patch logo_url(@logo), params: { logo: { brand_id: @logo.brand_id, description: @logo.description, file_data: @logo.file_data, name: @logo.name } }
