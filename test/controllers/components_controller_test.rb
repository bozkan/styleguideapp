...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { brand_id: @component.brand_id, description: @component.description, markup: @component.markup, name: @component.name, style: @component.style } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { brand_id: @component.brand_id, description: @component.description, markup: @component.markup, name: @component.name, style: @component.style } }
